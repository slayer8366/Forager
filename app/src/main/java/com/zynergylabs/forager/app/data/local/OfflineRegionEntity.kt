 ...
 * heuristic — see `com.zynergylabs.forager.app.map.MapLibreOfflineMapRepository`.
 *
 * Every other column is written into the region's own metadata blob too (see
 * `com.zynergylabs.forager.app.map.RegionMetadata`), not just here — the design doc's own reasoning: "the blob
