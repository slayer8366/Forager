 ...
 * [com.zynergylabs.forager.app.domain.model.CapSection]'s doc comment), so chips toggle membership rather than
 ...
 * present (a colour change, a latex/exudate colour) — see [com.zynergylabs.forager.app.domain.model.ContextFleshSection].
 */
@Composable
