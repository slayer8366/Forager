...
object GeoDistance {
     ...
     * `OsmdroidOfflineMapRepository` originally, now [com.zynergylabs.forager.app.map.MapLibreOfflineMapRepository]
     ...
     * [com.zynergylabs.forager.app.ui.map.SightingsMap] already has (see that composable's own doc comment on
     ...
     * [com.zynergylabs.forager.app.domain.CompassProvider.heading] is magnetic-north-relative, and
