 ...
 * [com.zynergylabs.forager.app.domain.SavePlannedTripUseCase] does.
 *
...
data class MushroomLogEntry(
     ...
     * [com.zynergylabs.forager.app.data.local.MushroomLogEntryEntity.isDraft] for the column it maps onto.
     */
    val isDraft: Boolean,
    /**
     ...
     * [com.zynergylabs.forager.app.data.local.MushroomLogEntryEntity.draftOfEntryId]'s own doc comment for the
