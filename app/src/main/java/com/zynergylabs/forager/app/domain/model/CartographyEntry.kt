 ...
 * display text plus the id [MushroomLogEntry]/[Track]/[Waypoint]/[com.zynergylabs.forager.app.domain.OfflineRegionMetadata]
 ...
 * anything — see [com.zynergylabs.forager.app.data.local.CartographyEntryTrackRefEntity]'s own doc comment for the
...
data class CartographyEntry(
     ...
     * [com.zynergylabs.forager.app.data.local.CartographyEntryPhotoRefEntity]'s own doc comment for why a photo
...
/** A decision about one offline region, plus its own display text — [radiusKm] is the region's search-radius parameter, not a live tile count (see [com.zynergylabs.forager.app.domain.OfflineRegionMetadata], which this is snapshotted from). */
...
/** One manually-attached photo's own minimal snapshot — [attachedAtEpochMillis] is when the user attached it, not [LogPhoto.createdAtEpochMillis]. See [com.zynergylabs.forager.app.data.local.CartographyEntryPhotoRefEntity]'s own doc comment for why this exists at all. */
