 ...
 * [com.zynergylabs.forager.app.domain.model.GalleryPhoto.referencingEntryIds]; by the time this runs, the user
 ...
 * would point at a file that no longer exists, which [com.zynergylabs.forager.app.domain.model.GalleryPhoto]'s
