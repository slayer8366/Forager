 ...
 * [GetTripWindowsUseCase]'s call: that class discards the raw [com.zynergylabs.forager.app.domain.model.WeatherSeries]
 * once [ComputeTripWindowsUseCase] has reduced it to a [com.zynergylabs.forager.app.domain.model.TripWindowReport],
 ...
 * [com.zynergylabs.forager.app.data.repository.OpenMeteoWeatherProvider.fetch]'s own doc comment.
 */
class GetTodaysForecastUseCase(
    private val weatherProvider: TripPlanningWeatherProvider,
) {
    /** The first forecast day in the series — the reference day itself; see [com.zynergylabs.forager.app.domain.model.DailyWeather.isForecast]. */
