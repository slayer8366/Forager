...
/**
 * Room's on-disk shape for one [com.zynergylabs.forager.app.domain.model.LogPhoto] — a standalone gallery row,
 ...
 * [com.zynergylabs.forager.app.domain.model.LogPhoto]'s own doc comment for the full reasoning. `null` for
...
data class LogPhotoEntity(
    ...
    /** Relative to app-private storage — see [com.zynergylabs.forager.app.domain.model.LogPhoto.relativePath]. */
    val relativePath: String,
    /** `null` only for a row migrated from before this column existed — see [com.zynergylabs.forager.app.domain.model.LogPhoto.createdAtEpochMillis]. */
