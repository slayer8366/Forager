...
interface MushroomRepository {
     ...
     * [SightingsPage.sightings][com.zynergylabs.forager.app.domain.model.SightingsPage.sightings], never
     ...
     *   [com.zynergylabs.forager.app.data.repository.INaturalistMushroomRepository]'s `toDomain` for the
     *   field this is gated on and why.
     *
     * Every [Sighting][com.zynergylabs.forager.app.domain.model.Sighting] that does come back carries its own
     * positional accuracy (ordinary GPS error, which is not filtered — see
     * [Sighting.positionalAccuracyMeters][com.zynergylabs.forager.app.domain.model.Sighting.positionalAccuracyMeters]),
