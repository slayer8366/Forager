 ...
 * format directly. Domain and UI code depend on [com.zynergylabs.forager.app.domain.MushroomRepository]
 ...
 * every call this app makes; see [com.zynergylabs.forager.app.domain.model.TaxonFilter].
 *
