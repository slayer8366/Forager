...
interface LocationTracker {
     ...
     * [com.zynergylabs.forager.app.domain.LocationSampler] decides which of these become persisted
     * [com.zynergylabs.forager.app.domain.model.TrackPoint]s; this stream's job is only to report what the
     * device actually saw.
     *
...
sealed interface LocationFix {
     ...
     * same rule as [com.zynergylabs.forager.app.domain.LocationResult.Success.altitude].
     *
...
/**
 * The fix as a candidate [com.zynergylabs.forager.app.domain.model.TrackPoint] for [LocationSampler] — field
 ...
 */
fun LocationFix.Update.toTrackPoint() = com.zynergylabs.forager.app.domain.model.TrackPoint(
    lat = lat,
    lng = lng,
    altitude = altitude,
