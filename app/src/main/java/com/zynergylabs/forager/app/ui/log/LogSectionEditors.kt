...
/** [SporePrint.readOn] is normally a day or more after [MushroomLogEntry.foundOn][com.zynergylabs.forager.app.domain.model.MushroomLogEntry.foundOn] — see this section's doc comment on deferred observation — so its date picker is edited independently, not derived from the find date. */
