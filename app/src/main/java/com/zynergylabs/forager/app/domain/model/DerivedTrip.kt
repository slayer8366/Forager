 ...
 * everything [com.zynergylabs.forager.app.domain.GetDerivedTripUseCase] gathered for [date]. **Stores nothing of
 ...
 * committed entries — see [com.zynergylabs.forager.app.domain.GetDerivedTripUseCase]'s own doc comment for why
...
data class DerivedTrip(
    ...
    val offlineRegions: List<com.zynergylabs.forager.app.domain.OfflineRegionMetadata>,
)
