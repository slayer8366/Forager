...
interface MushroomLogRepository {
     ...
     * Stage 2a's derived-trip read. [foundOnKey] is [com.zynergylabs.forager.app.domain.LocalDayRange.foundOnKey].
     * No draft/committed filtering — see `com.zynergylabs.forager.app.data.local.MushroomLogDao.getEntriesForDay`'s own doc comment.
     */
