 ...
 * routinely start without one; see [com.zynergylabs.forager.app.domain.model.MushroomLogEntry.foundAt]'s own
 * doc comment.
 *
 ...
 * [com.zynergylabs.forager.app.domain.model.LogPhoto]'s own doc comment for why a migrated row's creation time
 ...
 * [com.zynergylabs.forager.app.domain.model.MushroomLogEntry] stays untouched.
 *
 ...
 * [com.zynergylabs.forager.app.data.local.MushroomLogEntryEntity], and for the same reason: `LogPhotoEntity` is
 ...
 * [com.zynergylabs.forager.app.domain.model.WaypointDesignation] for why this is a column and not a naming
 ...
 * the reader ([com.zynergylabs.forager.app.domain.movingPace]) treats as "use point differencing", not as
