...
data class MapPalette(
     ...
     * an [com.zynergylabs.forager.app.ui.availability.ObservationBubble] open on it, so the bubble's own arrow
    ...
    companion object {
         ...
         * and reverted on request — see [com.zynergylabs.forager.app.ui.map.SIGHTING_DOT_STROKE_WIDTH_PX]'s own
