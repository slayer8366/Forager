...
/**
 * Settings' theme choice, persisted via [com.zynergylabs.forager.app.domain.AppThemePreferenceRepository].
 ...
 * [com.zynergylabs.forager.app.domain.MapPreferencesRepository]'s own night-mode-maps preference already set.
