 ...
 * the user has put something there). Unlike [com.zynergylabs.forager.app.domain.SavePlannedTripUseCase], there's
 * no required field to validate first, since every section starts as
 * [com.zynergylabs.forager.app.domain.model.Observed.NotObserved]/[com.zynergylabs.forager.app.domain.model.Feature.NotObserved]
