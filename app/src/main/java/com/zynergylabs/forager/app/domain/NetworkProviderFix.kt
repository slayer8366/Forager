 ...
 * (dispatch, format B1): [com.zynergylabs.forager.app.domain.TrackRepository.getFullRecord] carries every
 ...
 * [com.zynergylabs.forager.app.data.repository.RoomTrackRepository.getFullRecord].
 */
 ...
 * produces — one rule today. [com.zynergylabs.forager.app.domain.GpxCodec] writes it on the record block so a
 ...
 * declaration, [com.zynergylabs.forager.app.domain.model.TrackPointRecord.excludedByRule] is what each point actually met, and a file whose
