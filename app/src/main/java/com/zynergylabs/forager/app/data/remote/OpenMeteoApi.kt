 ...
 * directly. Domain and UI code depend on [com.zynergylabs.forager.app.domain.WeatherProvider] and
 * [com.zynergylabs.forager.app.domain.TripPlanningWeatherProvider] instead, per the isolated-integration-layer
 * rule in CLAUDE.md.
 */
interface OpenMeteoApi {
     ...
     * [com.zynergylabs.forager.app.data.remote.dto.HourlySoilDto] for the measurements showing why.
     */
    @GET("v1/forecast")
