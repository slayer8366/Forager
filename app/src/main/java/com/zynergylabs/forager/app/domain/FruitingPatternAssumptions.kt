 ...
 * [com.zynergylabs.forager.app.data.repository.OpenMeteoWeatherProvider.SIGNIFICANT_RAIN_MM] does (CLAUDE.md:
...
object FruitingPatternAssumptions {
     ...
     *
     * Single source of truth — [com.zynergylabs.forager.app.data.repository.OpenMeteoWeatherProvider]'s
