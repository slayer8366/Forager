package com.zynergylabs.forager.app.data.local.fungiindex
 ...
 * [com.zynergylabs.forager.app.data.local.ForagerDatabase], which holds the user's own journal, tracks,
 ...
 * `com.zynergylabs.forager.app.tools.GenerateFungiIndexDbAsset`, run via `scripts/generate_fungi_index_db.sh`
