...
/**
 * The result of one [com.zynergylabs.forager.app.domain.MushroomRepository.getSightings] call: the mappable
 ...
 * [com.zynergylabs.forager.app.data.repository.INaturalistMushroomRepository]'s `toDomain`). Comparing
