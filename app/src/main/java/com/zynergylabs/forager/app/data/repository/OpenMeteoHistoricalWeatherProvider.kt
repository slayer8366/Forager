...
import com.zynergylabs.forager.app.data.remote.OpenMeteoArchiveApi
import com.zynergylabs.forager.app.data.remote.dto.HistoricalPrecipitationResponseDto
 ...
 * at. This is the same simplification [GetConditionsUseCase][com.zynergylabs.forager.app.domain.GetConditionsUseCase]
 ...
 * confirmed-dry one, and [ComputeTripWindowsUseCase.findSoakingEvents][com.zynergylabs.forager.app.domain.ComputeTripWindowsUseCase]'s
