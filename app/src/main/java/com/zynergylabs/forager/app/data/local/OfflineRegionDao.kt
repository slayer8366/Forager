...
interface OfflineRegionDao {
     ...
     * a separate, date-independent question — see `com.zynergylabs.forager.app.domain.isCoordinateWithinRegionTiles`).
     * Half-open range, `[dayStartInclusive, dayEndExclusive)` — see
     * [com.zynergylabs.forager.app.domain.LocalDayRange]'s own doc comment for why.
     */
    ...
    /** Replace-on-conflict: also how [com.zynergylabs.forager.app.map.MapLibreOfflineMapRepository] self-heals a row rebuilt from the region's own metadata blob. */
