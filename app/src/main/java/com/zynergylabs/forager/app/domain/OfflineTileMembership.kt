 ...
 * [com.zynergylabs.forager.app.domain.OfflineMapRepository.MIN_ZOOM] would call a point kilometers outside the
 * region "within its tiles," while [com.zynergylabs.forager.app.domain.OfflineMapRepository.MAX_ZOOM] gives the
