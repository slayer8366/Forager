 ...
 *
 * [android.util.Log] is not safe to call directly from [com.zynergylabs.forager.app.ui.availability.AvailabilityViewModel]
 * or [com.zynergylabs.forager.app.ui.track.TrackRecordingViewModel]: both are deliberately plain-JVM testable,
