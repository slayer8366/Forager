...
abstract class MushroomLogDao {
     ...
     * [com.zynergylabs.forager.app.domain.LocalDayRange.foundOnKey] — an exact string match, not a range, since
     ...
     * [com.zynergylabs.forager.app.domain.GetMushroomLogEntriesUseCase] already does for the unscoped read.
     */
     ...
     * photo row — the fire-and-forget write [com.zynergylabs.forager.app.ui.log.MushroomLogViewModel] issues
     ...
     * transaction commits (see [com.zynergylabs.forager.app.domain.DeleteGalleryPhotoUseCase]'s own doc comment
