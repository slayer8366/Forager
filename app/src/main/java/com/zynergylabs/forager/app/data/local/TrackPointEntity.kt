...
/**
 * Room's on-disk shape for one [com.zynergylabs.forager.app.domain.model.TrackPoint], keyed to its owning
 ...
 * [com.zynergylabs.forager.app.domain.model.TrackRecordingMode]), so [trackId] is indexed — unlike
 ...
 * [com.zynergylabs.forager.app.domain.model.TrackPoint] for the field's meaning and its `null` rule.
 */
