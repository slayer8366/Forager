...
interface WaypointRepository {
     ...
     * read path for [com.zynergylabs.forager.app.domain.model.Waypoint.trackId] (HUD-foundations dispatch,
    ...
    /**
     * Nulls [com.zynergylabs.forager.app.domain.model.Waypoint.trackId] on every waypoint linked to [trackId],
