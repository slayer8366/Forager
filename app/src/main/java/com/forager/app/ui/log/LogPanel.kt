...
internal fun LogPanel(
    ...
    tracks: List<Track>,
    onTracksOpened: () -> Unit,
    /** GPX full-record export dispatch — see [com.forager.app.ui.track.TrackExportList]'s own doc comment. Defaults empty/no-op so no other caller of this panel changes. */
