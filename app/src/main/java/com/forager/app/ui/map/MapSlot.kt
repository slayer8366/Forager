 ...
 * [Basemap] crosses this seam as this project's own type, not a vendor tile-source type, for the
 * same reason the rest of the seam exists: the screen names the basemap it wants and stays ignorant
 * of which vendor supplies the tiles. [modifier] is last because it is the slot's *size contract* —
 * the screen decides how much room the map gets, which is the one thing about this arrangement the
