 ...
 * map (the long-press gesture this app already uses for a planned trip or a mushroom-log find) is
 * Phase 1c work, once the map layer it needs is on the new renderer.
 *
