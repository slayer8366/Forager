 ...
 * [com.forager.app.domain.GeoDistance.boundingBox]; the one place it becomes a vendor bounds type is
 * `com.forager.app.map.MapLibreOfflineMapRepository`, which turns it into a MapLibre `LatLngBounds`
