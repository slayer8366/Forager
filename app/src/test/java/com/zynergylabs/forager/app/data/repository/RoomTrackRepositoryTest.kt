 ...
 * [TrackRepository][com.zynergylabs.forager.app.domain.TrackRepository]'s doc comment makes. See its printed
...
class RoomTrackRepositoryTest {
    ...
    /**
     * A multi-hour recording at [com.zynergylabs.forager.app.domain.model.TrackRecordingMode.HIGH_ACCURACY]'s
