...
private class FakeSightingsRepository(
    ...
    override suspend fun getSpeciesCounts(region: Region, month: Int, filter: TaxonFilter) = Result.success(emptyList<com.zynergylabs.forager.app.domain.model.SpeciesObservationCount>())
