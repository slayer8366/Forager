...
import com.zynergylabs.forager.app.domain.model.AnnulusType
import com.zynergylabs.forager.app.domain.model.Association
import com.zynergylabs.forager.app.domain.model.CapDecoration
import com.zynergylabs.forager.app.domain.model.CapMargin
import com.zynergylabs.forager.app.domain.model.CapSection
import com.zynergylabs.forager.app.domain.model.CapShape
import com.zynergylabs.forager.app.domain.model.CapSurface
...
import com.zynergylabs.forager.app.domain.model.FleshTexture
import com.zynergylabs.forager.app.domain.model.ForestType
import com.zynergylabs.forager.app.domain.model.GillAttachment
import com.zynergylabs.forager.app.domain.model.GillEdge
import com.zynergylabs.forager.app.domain.model.GillSpacing
import com.zynergylabs.forager.app.domain.model.HostHealth
...
import com.zynergylabs.forager.app.domain.model.LogSyncState
import com.zynergylabs.forager.app.domain.model.MushroomLogEntry
import com.zynergylabs.forager.app.domain.model.Observed
import com.zynergylabs.forager.app.domain.model.SporePrint
import com.zynergylabs.forager.app.domain.model.SporePrintColor
import com.zynergylabs.forager.app.domain.model.SporePrintSection
import com.zynergylabs.forager.app.domain.model.StipeBase
import com.zynergylabs.forager.app.domain.model.StipeDetails
import com.zynergylabs.forager.app.domain.model.StipeInterior
import com.zynergylabs.forager.app.domain.model.StipePosition
import com.zynergylabs.forager.app.domain.model.StipeSection
import com.zynergylabs.forager.app.domain.model.VeilSection
import com.zynergylabs.forager.app.domain.model.VolvaType
 ...
 * itself is responsible for, here considerably larger than [com.zynergylabs.forager.app.data.local.PlannedTripEntity]'s:
 * every [Observed]/[Feature] column encoding described in [com.zynergylabs.forager.app.data.local.MushroomLogEntryEntity]'s
...
class RoomMushroomLogRepositoryTest {
    ...
    /**
     * L1's reversal, at the Room level (see [com.zynergylabs.forager.app.domain.DeleteMushroomLogEntryUseCase]'s
    ...
    fun `getAllPhotos returns every gallery photo paired with the entries currently referencing it`() = runTest {
        ...
        val shared = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "shared", relativePath = "photos/shared.jpg", createdAtEpochMillis = 1_000L)
        val onlyA = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "only-a", relativePath = "photos/only-a.jpg", createdAtEpochMillis = 2_000L)
    ...
    fun `getAllPhotos includes a photo with zero referencing entries`() = runTest {
        val orphaned = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "orphaned", relativePath = "photos/orphaned.jpg", createdAtEpochMillis = 5_000L)
    ...
    fun `a standalone photo appears in the Album, survives a round trip, and can be pulled into a find`() = runTest {
        val standalone = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "standalone", relativePath = "photos/standalone.jpg", createdAtEpochMillis = 3_000L)
    ...
    fun `attaching the same photo to the same entry twice does not duplicate the reference`() = runTest {
        ...
        val photo = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "p1", relativePath = "photos/p1.jpg", createdAtEpochMillis = 1_000L)
        repository.save(entry).getOrThrow()
        repository.addPhotoToGallery(photo).getOrThrow()
    ...
    fun `a photo referenced by two entries, pulled into a third, is referenced by three`() = runTest {
        ...
        val photo = com.zynergylabs.forager.app.domain.model.LogPhoto(id = "shared", relativePath = "photos/shared.jpg", createdAtEpochMillis = 1_000L)
        repository.save(entryA).getOrThrow()
        repository.save(entryB).getOrThrow()
