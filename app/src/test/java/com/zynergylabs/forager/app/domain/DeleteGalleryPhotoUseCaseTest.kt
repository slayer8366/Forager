 ...
 * real Room-backed row/cross-reference deletion is [com.zynergylabs.forager.app.data.repository.RoomMushroomLogRepositoryTest]'s
 * to prove.
 */
...
private class DeleteFakePhotoStore(
    ...
    override suspend fun persist(source: com.zynergylabs.forager.app.domain.model.PhotoSource): Result<LogPhoto> =
        Result.failure(UnsupportedOperationException("not exercised by this use case"))
