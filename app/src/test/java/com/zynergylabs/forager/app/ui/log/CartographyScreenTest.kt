 ...
 * the identical report/edit problem on [com.zynergylabs.forager.app.domain.model.MushroomLogEntry] — plain local
    ...
    private fun setScreen(initial: CartographyUiState) {
        composeRule.setContent {
            ...
            CartographyScreen(
                ...
                getCurrentLocation = { com.zynergylabs.forager.app.domain.LocationResult.LocationUnavailable },
                onOpenEntry = { id ->
