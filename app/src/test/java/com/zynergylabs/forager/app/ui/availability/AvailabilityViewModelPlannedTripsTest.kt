...
private object PlannedTripsNoOpLocationTracker : LocationTracker {
    override val fixes: Flow<LocationFix> = emptyFlow()
}

private object PlannedTripsEmptyRepository : MushroomRepository, TaxonSearchRepository {
...
private object PlannedTripsStubUnitSystemPreferenceRepository : UnitSystemPreferenceRepository {
...
class AvailabilityViewModelPlannedTripsTest {
    ...
    private fun viewModel(repository: PlannedTripRepository): AvailabilityViewModel = AvailabilityViewModel(
        ...
        locationTracker = PlannedTripsNoOpLocationTracker,
        ...
        unitSystemPreferenceRepository = PlannedTripsStubUnitSystemPreferenceRepository,
        appThemePreferenceRepository = PlannedTripsStubAppThemePreferenceRepository,
        getTodaysForecast = GetTodaysForecastUseCase(PlannedTripsStubTripPlanningWeatherProvider),
    )
