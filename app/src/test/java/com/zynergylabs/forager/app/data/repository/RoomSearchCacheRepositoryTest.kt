...
class RoomSearchCacheRepositoryTest {
    ...
    /**
     * The degradation contract from [com.zynergylabs.forager.app.domain.SearchCacheRepository]: a storage
     ...
     * [com.zynergylabs.forager.app.data.local.CachedSearchPayload] wrote, and one storing neither filter
