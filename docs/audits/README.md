...
| 2026-09-06 | Pre-build report: location accuracy dispatch (live-fix gate at 50 m with the held-fix aging consequence, honest distance precision via `within`/`≈`, fused provider costed from the artifacts and stopped on the build-variant requirement) | `2026-09-06-location-accuracy-prebuild-report.md` |
