...
# out of a real, running Room database (com.zynergylabs.forager.app.data.local.fungiindex.FungiIndexDatabase),
...
# matching hash. See com.zynergylabs.forager.app.tools.GenerateFungiIndexDbAsset's doc comment for the full
...
./gradlew testDebugUnitTest \
    --tests "com.zynergylabs.forager.app.tools.GenerateFungiIndexDbAsset" \
